 ...
 * Il décide de la survie ou de la mort d'une cellule selon ces critères.
 * 
...
public class VisiteurChaos extends Visiteur {
     ...
     * Si la cellule a exactement 3 voisins vivants ou un facteur aléatoire se déclenche,
